...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    user: COMPANY_EMAIL,
    pass: 'duhx ugyr lamv rlhz',// App password from Gmail
  },
});
...
export async function sendConfirmationEmail(toEmail, reservationDetails) {
  try {    
    const template = `<div
  style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff; color: #333333;"
>

  <div style="text-align: center; margin-bottom: 30px;">
    <img src="https://raw.githubusercontent.com/FarshadJahanfard/Dev-Project-/refs/heads/Email-confirmation/public/zenflow.png?token=GHSAT0AAAAAADCJUAZ457GNS4W5EDUVSQ2A2AL5Z2A" alt="ZenFlow Logo" style="width: 150px; height: auto;" />
  </div>
    ...
    <table style="width: 100%; border-collapse: collapse;">
      <tbody>
        ...
        <tr>
          ...
          <td style="padding: 10px 0; border-bottom: 1px solid #e2e8f0;">${reservationDetails.time}</td>
        </tr>
        <tr>
  ...
  <div style="border-top: 1px solid #e2e8f0; padding-top: 20px; text-align: center; color: #718096; font-size: 14px;">
    <p>
      ...
      <a href="mailto:${COMPANY_EMAIL}" style="color: #3182ce; text-decoration: none;"> email </a>
    </p>
    ...
    const mailOptions = {
        from: 'contactzenflow.com@gmail.com',
        to: toEmail,
